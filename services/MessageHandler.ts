...
export class MessageHandler {
    ...
    private static async parseExpletives(msg: Message){
        ...
        let currentExpletivesMap : Map<string, number> = await this.commandService.getExpletives(guildId);
        let expletiveList = Array.from(currentExpletivesMap.keys());
        ...
        this.commandService.updateGuildWideExpletiveTotals(guildId, currentExpletivesMap);
    }
